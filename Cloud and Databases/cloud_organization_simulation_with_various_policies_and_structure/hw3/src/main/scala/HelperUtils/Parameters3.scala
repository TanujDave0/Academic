...
* */
object Parameters3:
  private val logger = CreateLogger(classOf[Parameters3.type])
  val config = ObtainConfigReference("homework3_3") match {
...
//    case Long => Long
  ...
  private def func4Parameter[T](defaultVal: T, f: String => T): String => T =
    (pName: String) => Try(f(s"homework3_3.$pName")) match {
