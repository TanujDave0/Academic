...
import HelperUtils.{CreateLogger, Parameters2}
...
object hw3_Round_Robin:
  // importing all parameters for our simulation from our conf file
  import HelperUtils.Parameters2.*
  private val logger = CreateLogger(classOf[hw3_Round_Robin.type]) // creating a logger for it

  // getting all the variables from the conf for this simulation

  // for hosts
  val HOSTS = Parameters2.HOSTS
  val HOST_PES = Parameters2.HOST_PES
  val HOST_MIPS = Parameters2.HOST_MIPS
  val HOST_RAM = Parameters2.HOST_RAM
  val HOST_BW = Parameters2.HOST_BW
  val HOST_STORAGE = Parameters2.HOST_STORAGE

  // for VMs
  val VMS = Parameters2.VMS
  val VM_PES = Parameters2.VM_PES
  val VM_MIPS = Parameters2.VM_MIPS
  val VM_RAM = Parameters2.VM_RAM
  val VM_BW = Parameters2.VM_BW
  val VM_SIZE = Parameters2.VM_SIZE
  val VM_SCALING_FACTOR = Parameters2.VM_SCALING_FACTOR
  val VM_SCALING_UPPER_THRESHOLD = Parameters2.VM_SCALING_UPPER_THRESHOLD
  val VM_SCALING_LOWER_THRESHOLD = Parameters2.VM_SCALING_LOWER_THRESHOLD

  // for Cloudlets
  val CLOUDLETS = Parameters2.CLOUDLETS
  val CLOUDLET_PES = Parameters2.CLOUDLET_PES
  val CLOUDLET_LENGTH = Parameters2.CLOUDLET_LENGTH
  val CLOUDLET_SIZE = Parameters2.CLOUDLET_SIZE
  val CLOUDLET_DYNAMIC_USAGE = Parameters2.CLOUDLET_DYNAMIC_USAGE

  val INTERVAL = Parameters2.INTERVAL
  ...
  val datacentre0 = createDatacenterRoundRobin()
...
//      temp2.setCloudletScheduler(new CloudletSchedulerTimeShared())
  ...
  @main def hw3_Round_Robin_main() = {simulate_round_robin()}
