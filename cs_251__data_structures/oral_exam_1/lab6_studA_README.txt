...
**********************
About - The file contains the closing prices of the Dow Jones stock market index over the last 30 years. The first row in the text file contains the column headers for "Year" and "Price". Each remaining row contains an integer year followed by the closing price (double) for that year. The values are separated by a space. As you work through the problem state any assumptions.
