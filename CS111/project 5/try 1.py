...
g_cored2 = nx.k_core(g2, 3) #graph is very big so cored to 100
...
text.write('The 3 cored graph for second analysis is really messy and has a lot of nodes, also takes about 30secs to display. Has some dense areas which are further linked. But if we core it to 100, it has around 180 nodes')
text.close()
